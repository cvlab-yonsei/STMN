...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_dir',help='path/to/DukeV/',default='./dukeV')
    ...
    np.savetxt(os.path.join(args.output_dir,'test_path.txt'),gallery_imgs_path,fmt='%s',delimiter='\n')
    np.save(os.path.join(args.output_dir,'test_info.npy'),np.array(infos))
